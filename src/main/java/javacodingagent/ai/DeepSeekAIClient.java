...
public class DeepSeekAIClient extends AiServices{
    private final OkHttpClient client;
    private final static String MODEL = ConfigManager.getProperty("ai.model");

    public DeepSeekAIClient(String prompt, String apiKey){
        super(prompt, apiKey);
        //Set-Up Client http to connect api to LLM
